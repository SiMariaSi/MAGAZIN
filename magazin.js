...
//    }
    ...
    for (key in content_price) {
        ...
        <li style="width: 300px" class="d-flex flex-column m-1 p-1 border bgcolor="gray"">
...
//    }
    ...
    for (key in content_title) {
        node_for_insert.innerHTML += `
        <li style="width: 300px" class="d-flex flex-column m-1 p-1 border bg-body bgcolor="gray"">
        <img style="width: 300px" class="align-self-center" src=${content[key].img}>
        <h5 class="card-title">${content[key].title}</h5>
